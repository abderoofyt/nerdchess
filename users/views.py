...
class ProfileDetailView(LoginRequiredMixin,DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            friend_list.save()
        try:
            games_list = GameList.objects.get(user=account)
        except GameList.DoesNotExist:
            games_list = GameList(user=account)
            games_list.save()    
        friends = friend_list.friends.all()
        context['friends']=friends
        games = games_list.games.all()
        context['games']=games
...
""" User Game details view """
class GameDetailView(LoginRequiredMixin,DetailView):
    model = Profile
    template_name = "users/user_game_details.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        games = games_list.games.all()
        context['games']=games
        context['game']=games_list
        context['b']=games_list.black
        context['w']=games_list.white  
        context['user']=self.request.user
        if (self.request.user == games_list.black):
            context['flip']= True
