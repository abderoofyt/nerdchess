...
from friend.views import cancel_friend_request, decline_friend_request, friend_requests, friends_list_view, game_list_view, remove_friend, send_friend_request, accept_friend_request

app_name = "friend"

urlpatterns = [
    path('list/<user_id>', friends_list_view, name='list'),
    path('gamelist/<user_id>', game_list_view, name='game_list'),
